...
public class PDFLinkHandler implements LinkHandler {
    ...
    public PDFLinkHandler(Context context, PDFView pdfView, boolean preventLinkNavigation) {
    ...
    private void onLinkHandler(String uri) {
        if (FlutterPDFView.PDFStatusListener == null) {
            return;
        }
        FlutterPDFView.PDFStatusListener.onLinkRequested(uri);
    }
